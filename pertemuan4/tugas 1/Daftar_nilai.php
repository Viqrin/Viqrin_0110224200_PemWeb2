...
// Data Awal
$data_mhs[] = new NilaiMahasiswa("Viqrin Perdana Sakti", "Pemrograman Web2", 78, 89, 80);
$data_mhs[] = new NilaiMahasiswa("Ketua RT", "Basisdata", 47, 68, 85);
$data_mhs[] = new NilaiMahasiswa("Kepala Dusun", "UI/UX", 57, 78, 75);
$data_mhs[] = new NilaiMahasiswa("Bapak kapolri", "Komunikasi Efektif", 60, 80, 50);
$data_mhs[] = new NilaiMahasiswa("Aoy Gendut", "Statistik Probabilitas", 70, 75, 83);
