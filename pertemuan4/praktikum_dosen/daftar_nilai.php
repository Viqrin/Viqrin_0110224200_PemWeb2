...
///data awal
$data_mhs[] = new NilaiMahasiswa("Danang", "pemrograman web", 85, 25, 30);
$data_mhs[] = new NilaiMahasiswa("bung dellon", "pemrograman web", 23, 32, 54);
$data_mhs[] = new NilaiMahasiswa("dian", "pemrograman web", 75, 89, 90);
